...
from src.toolkit import granular_temperature, packing_fraction, bed_moment
...
def main():
    ...
    AVG.apply_scalar_function(bed_moment)
    AVG.print_fields()
    ...
    # superficie.check_surface().residence_time()
    # print(superficie.get_data())
    # view_surface(superficie, index=0)
    # print(superficie.residence_fraction)
