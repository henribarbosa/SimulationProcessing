...
from src.toolkit import granular_temperature
from src.graphics import last_quiver_view, last_scalar_view, view_particles, view_average_areas
...
def main():
    ...
    Data = simulation_data("/media/dados0/Mestrado/Leito_Ar/Polydisperse_difelice/Mono_Velocidade_1.77_angle_0/DEM/post/",
                           max_number_files=1000, skip_step=100)
